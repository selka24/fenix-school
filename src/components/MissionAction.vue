<template>
  <section class="py-12 bg-white">
    <div class="container mx-auto px-4">
      <!-- Section Title -->
      <h2 class="text-4xl font-bold text-center text-[#c11574] mb-12">
        {{$t('home.missionAction')}}
      </h2>
      
      <!-- News & Stories Header -->
      <div class="text-center mb-10">
        <span class="inline-block px-4 py-2 bg-[#c11574] text-white font-semibold">
      ...
      <div class="flex justify-center mt-8 space-x-2">
        ...
        <button class="w-2 h-2 rounded-full bg-[#c11574]"></button>
      </div>
    </div>
  </section>
</template>
