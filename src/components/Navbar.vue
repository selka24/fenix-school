<template>
  <nav class="bg-white pb-4 shadow-sm">
    ...
    <div class="container mx-auto flex justify-center items-center px-4 py-1 bg-gray-100">
        <!-- Main Navigation -->
        <div class="hidden lg:flex justify-between max-w-5xl w-full">
            <div
    ...
    <div class="container mx-auto flex justify-between items-center px-4 pt-4">
